...
$conn = mysqli_connect('localhost','root','','robot_arm_db');





$sql = mysqli_query($conn,"INSERT INTO robot_arm_db(servo1,servo2,servo3,servo4,servo5,servo6) VALUES ('$servo1', '$servo2', '$servo3', '$servo4', '$servo5',$servo6)");
...
$sql = mysqli_query($conn,"UPDATE robot_arm_db SET status='1' WHERE servo1='$servo1' AND servo2='$servo2' AND servo3='$servo3' AND servo4='$servo4' AND servo5='$servo5' AND servo6='$servo6'");	
